...
const Section3 = ({ threeImages, handleImageUpload, handleCancel, handleSave }:any) => {
  return (
    <section className="bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-3xl font-semibold text-center text-gray-800 mb-6">
        Section 3: Edit 3 Images
      </h2>
      ...
      {/* 3 Image Upload Inputs */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {threeImages.map((image: { image: any; alt: string | undefined; }, index: Key | null | undefined) => (
          <div key={index} className="flex flex-col items-center space-y-4">
            ...
            <input
              type="file"
              onChange={(e) => handleImageUpload(e, index, "threeImages")}
